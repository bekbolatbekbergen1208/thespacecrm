...
const industryConfigs: Record<BusinessIndustry, IndustryDashboardConfig> = {
  "Retail Store": {
    ...
    nav: [["Товары и продажи", "/dashboard/retail"], ["Календарь", "/dashboard/retail"], ["Отчёты", "/dashboard/retail"], ["Клиенты", "/dashboard/customers"], ["Сотрудники", "/dashboard/employees"]],
    ...
    windows: [{ title: "Товары", href: "/dashboard/retail", metric: "Catalog", detail: "Добавляйте товары с фото, названием и ценами." }, { title: "Продажи", href: "/dashboard/retail", metric: "Revenue", detail: "Назначайте товар проданным и считайте остаток." }, { title: "Календарь", href: "/dashboard/retail", metric: "Daily", detail: "Смотрите продажи за выбранный день." }, { title: "Отчёты", href: "/dashboard/retail", metric: "CSV", detail: "Скачивайте дневной отчёт по продажам." }],
