  ...
  return `
    <article class="contract">
      ...
      ${section("2. Стоимость услуг и порядок оплаты", `
        ...
        <p>2.4. Абонемент действует строго 30 календарных дней с даты покупки/оплаты, если иной срок письменно не согласован сторонами. По истечении указанного срока неиспользованные занятия не переносятся и не компенсируются, за исключением случаев, прямо предусмотренных настоящим договором или применимым законодательством.</p>
      `)}
      ...
      ${section("4. Посещаемость, переносы и возвраты", `
        <p>4.1. С 6 июля вступают в силу обновлённые правила использования абонементов. Данные изменения распространяются на все действующие и новые абонементы, если иное письменно не согласовано с Исполнителем.</p>
        <p>4.2. Если обучающийся не может посетить занятие по своему расписанию, Заказчик обязан заранее уведомить администрацию. При предварительном уведомлении обучающийся может посетить занятие в другой день этой же календарной недели только при наличии свободных мест.</p>
        <p>4.3. Чтобы гарантировать место на следующую неделю, Заказчику рекомендуется заранее бронировать занятия по воскресеньям либо в иной срок, установленный администрацией центра.</p>
        <p>4.4. Если в выбранный день свободных мест нет, пропущенное занятие считается использованным и не переносится на следующую неделю.</p>
        <p>4.5. Если обучающийся уезжает в отпуск, Заказчик обязан заранее сообщить администрации центра. В этом случае пропущенные занятия могут быть перенесены только в пределах текущего календарного месяца и только при наличии свободных мест. Перенос занятий на следующий месяц не предусмотрен.</p>
        <p>4.6. Система учёта абонемента по количеству посещений отменяется. Абонемент рассчитан на посещение занятий по расписанию два раза в неделю в течение срока действия абонемента, а не на фиксированное количество посещений.</p>
        <p>4.7. Возврат денежных средств возможен только в течение 5 календарных дней после покупки/оплаты абонемента на основании письменного заявления Заказчика. Возврат производится с учётом фактически оказанных услуг, использованных занятий, предоставленных скидок, комиссий платёжных систем и иных фактически понесённых расходов Исполнителя, если иное не предусмотрено применимым законодательством.</p>
      `)}
